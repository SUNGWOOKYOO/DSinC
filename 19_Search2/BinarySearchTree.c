...
#include "AVLRebalance.h" // AVLTree 구현을 위해 reblance함수를 insert와 delete끝에 사용하기 위해 기능 함수 추가 
...
void BSTInsert(BTreeNode ** pRoot, BSTData data)
{
	...
	//'BinarySearchTree3.h' 기능 ; AVLTree구현을 위한 코드 추가 ; insert와 delete에 rebalance함수 추가 
